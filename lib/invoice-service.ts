      ...
      const invoice = await prisma.invoice.create({
        data: {
          ...
          discountAmount: booking.discountAmount || 0,
                gstAmount: booking.gstAmount && booking.gstAmount > 0 ? booking.gstAmount : 0,
      serviceTaxAmount: booking.serviceTaxAmount && booking.serviceTaxAmount > 0 ? booking.serviceTaxAmount : 0,
      otherTaxAmount: booking.otherTaxAmount && booking.otherTaxAmount > 0 ? booking.otherTaxAmount : 0,
      totalTaxAmount: booking.totalTaxAmount && booking.totalTaxAmount > 0 ? booking.totalTaxAmount : 0,
