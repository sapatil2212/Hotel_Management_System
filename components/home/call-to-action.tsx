    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          {/* Special Offer */}
          <div className="mb-10 p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 max-w-md mx-auto">
            <div className="text-3xl font-bold text-amber-300 mb-2">Save 20%</div>
            <div className="text-blue-100">on weekend stays this month</div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-8 py-6 text-lg font-semibold rounded-full"
              asChild
            >
              <Link href="/booking">
